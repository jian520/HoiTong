...
export default {
  ...
  toolbarDefaultBg: platform === "ios" ? "#2EB5AC" : "#2EB5AC",
  ...
  // Spinner
  defaultSpinnerColor: common.colorA,
  ...
  topTabBarActiveTextColor: platform === "ios" ?  common.colorA  : common.colorA,
  topTabActiveBgColor: undefined,
  topTabBarBorderColor: platform === "ios" ? "#a7a6ab" : "#a7a6ab" ,
  topTabBarActiveBorderColor: platform === "ios" ? common.colorA :common.colorA ,
