...
export default class Stepper extends Component {
            ...
            <View style={[styles.container, this.props.style]}>
                <View style={{flexDirection: 'row', }}>
                    ...
                    <View style={{
                        ...
                        <Text style={{textAlign: 'center', color: "#00c4b4", fontSize: 20, width: 40}}>{this.state.currentNumber}</Text>
                    </View>
    ...
    decrease() { // 单击减少
        ...
        DeviceEventEmitter.emit('DidChange', [newValue, this.props.type, "decrease"]);
    ...
    increase() { // 单击增加
        ...
        DeviceEventEmitter.emit('DidChange', [newValue, this.props.type, "increase"]);
