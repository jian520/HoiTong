    ...
    render() {
        ...
        return (
            ...
            <Content padder>
                    ...
                    <Text style={styles.title}>6.1 我需要甚麼時候開始向HoiTong海棠繳費？</Text>
                    ...
                    <Text style={styles.text}>按金及費用由我們上門收取你的存倉物品送入倉庫當天之前繳付。</Text>
                    <Text style={styles.title}>6.2 如何向HoiTong海棠繳費(月費)？</Text>
                    <Text
                    ...
                    <Text
                        style={styles.text}>在停止使用你的儲存服務之前，請確保你已經取回你所有物品。在HoiTong海棠收回儲存箱當天，即表示你已停止使用HoiTong海棠，你只需為當月服務付費。如果你有任何未還清的欠款，你需要在最後出倉前解決欠款。</Text>
