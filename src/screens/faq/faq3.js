            ...
            <Content padder>
                ...
                <Grid>
                    <Col>
                        ...
                        <ListItem>
                            <Text style={styles.text2}>HK$650/月</Text>
                        </ListItem>
                    </Col>
                    <Col>
                        <ListItem>
                        ...
                        <ListItem>
                            <Text style={styles.text2}>HK$585/月</Text>
                        </ListItem>
                    </Col>
                    <Col>
                        ...
                        <ListItem>
                            <Text style={styles.text2}>HK$520/月</Text>
                        </ListItem>
                    </Col>
                ...
                <Text style={styles.title}>3.2.3 有沒有其他服務費用？</Text>
                ...
                <Grid>
                    ...
                    <Text style={styles.title}>3.2.4 我不知道需要多少存倉空間，我應該如何做？</Text>
                    <Text style={styles.text}>請致電21750222給我們，告訴我們你的存倉要求，或透過Whatsapp 98409999 或 按此發送需要存倉物件的照片給我們。</Text>
                    ...
                    <Text style={styles.title}>3.3.2 你們會提供包裝物料嗎？</Text>
                    <Text style={styles.text}>如有需要，我們可於首次入倉時，向客人提供適量基本包裝材料。</Text>

                    <Text style={styles.text}>如需我們另外安排預先送遞包裝材料，將額外收取運送費用。</Text>

                    <Text style={styles.title}>3.3.3 我可以用你們的標準迷你箱 / 文件箱 / 掛衣箱嗎？</Text>
                    <Text style={styles.text}>你可以購買我們的文件箱和掛衣箱，分別為每個$9
                        及$49。你亦可以租用我們的標準迷你箱，租金為每箱每月$10。所有箱子會於首次入倉時送遞上門。</Text>

                    <Text style={styles.text}>如需我們另外安排預先送箱，將額外收取運送費用。</Text>

                    <Text style={styles.title}>3.3.4 我需要事先收拾/包裝好存倉物件嗎？</Text>
                    <Text
                        style={styles.text}>需要。我們的運輸團隊會盡所能幫助客人，迅速替客人完成收取物件的過程。每個計劃首次收取物件時均附有30分鐘免費搬運服務。而取回或再次收取物件的費用為每程$300，當中包括30分鐘卸貨時間。</Text>

                    <Text style={styles.text}>額外搬運時間將收取每30分鐘每人HK$150。</Text>

                    <Text style={styles.text}>請注意，在以下情況中您很可能需要更長的搬運時間。</Text>
                    <Text style={styles.text}>- 需要包裝傢俬</Text>
                    <Text style={styles.text}>- 停泊運輸車輛的位置與指定地址有一段距離</Text>
                    <Text style={styles.text}>- 指定地址沒有升降機</Text>
                    <Text style={styles.text}>- 只能經由樓梯運送</Text>

                    <Text style={styles.title}>3.3.5 你們提供傢私拆除 / 組裝服務嗎？</Text>
                    <Text style={styles.text}>有的。你只需提供需要拆除 / 組裝的傢私的資料，我們會提供報價。</Text>

                    <Text style={styles.title}>3.4 物品提取及遞送</Text>
                    <Text style={styles.title}>3.4.1 什麼才是'大型物品'?</Text>
                    ...
                    <Text style={styles.title}>3.4.2 如何安排上門收取物品(首次入倉)？</Text>
                    <Text style={styles.text}>只要你準備所有存倉物品，就可以致電給我們 21750222或whatsapp我們 98409999，我們便會立即安排。</Text>

                    <Text style={styles.title}>3.4.3 我可以如何追蹤自己存倉的物品？</Text>
                    <Text
                        style={styles.text}>當你的首次入倉確認之後，你可以登入你的帳戶，到'移動倉儲存'分頁的'在家中'部分見到你的所有物件，並已註明為'已安排入倉'，你可以加入相片及備註方便管理。</Text>

                    <Text style={styles.text}>你可以在'在倉庫'部分見到所有已入倉物件。</Text>

                    <Text style={styles.title}>3.4.4 如果我需要存入更多東西，應該如何做？</Text>
                    <Text style={styles.text}>只要登入你的帳戶，再到'移動倉儲存'的分頁。只要在'在家中'部分新增你需要存倉的物件，加入相片及備註，然後選取你需要入倉的日期和時間。</Text>

                    <Text style={styles.text}>我們團隊會盡快聯絡你確認新入倉物件。如果新物件所需空間多於你現有的儲存計劃，我們會告訴你所需迷你倉面積及價錢。</Text>

                    <Text style={styles.title}>3.4.5 我需要取回部分物品(出倉)，我下一步應該做什麼？</Text>
                    <Text style={styles.text}>只要登入你的帳戶，再到'移動倉儲存'的分頁。只要在'在倉庫'部分選取你需要出倉的物件，並按下'出倉'。選取你需要出倉的日期和時間。</Text>
                    ...
                    <Text style={styles.title}>3.4.8 我想更改地址，會有任何額外收費嗎？</Text>
                    ...
                    <Text style={styles.title}>3.4.9 我可以自己安排運輸到你的倉庫安排出入倉嗎？</Text>
                    <Text style={styles.text}>我們的客人大都選用我們的上門運輸服務，但如果你希望自己送上/提取存倉物件，我們亦可安排，但需收取少量手續費。詳情請致電
                        21750222了解。</Text>


                    <Text style={styles.title}>3.4.10 遇上惡劣天氣時會有何安排？</Text>
                    <Text
